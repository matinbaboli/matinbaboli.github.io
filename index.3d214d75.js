...
if (!sessionStorage.language) sessionStorage.language = "en";
...
allTexts.forEach((text)=>{
    ...
    if (sessionStorage.language === "fa") {
        ...
        text.innerHTML += (0, _engJs.en)[translationId];
...
projectsPageLinkArray.forEach((link)=>{
    let dynamicTextId;
    if (link.parentElement.firstElementChild === link) dynamicTextId = "official_link_explanation";
    else dynamicTextId = "personal_link_explanation";
    link.addEventListener("mouseover", ()=>{
        if (languageSelectorBigScreen.value === "fa") projectsLinkExplanation.textContent = (0, _faJs.fa)[dynamicTextId];
        else projectsLinkExplanation.textContent = (0, _engJs.en)[dynamicTextId];
...
window.addEventListener("scroll", ()=>{
    ...
    if (scrolledAmount <= checkpoint) opacity = 1 - scrolledAmount / checkpoint;
    else opacity = 0;
...
},{"./languages/eng.js":"joNyo","./languages/fa.js":"hziQN"}],"joNyo":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequire82ef")
